...
do_install() {
	...
	install -m 0644 ${S}/labels_mobilenet_nbg.txt ${D}${prefix}/local/demo-ai/computer-vision/models/mobilenet/labels_mobilenet_nbg.txt
	install -m 0644 ${S}/*.nb ${D}${prefix}/local/demo-ai/computer-vision/models/mobilenet/
}
